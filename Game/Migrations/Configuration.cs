    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Game.Models.dbContext>
    {
        ...
        protected override void Seed(Game.Models.dbContext context)
        {
            ...
            context.Budynki.AddOrUpdate(
              ...
              new Buildings {  Name = "Kopalnia węgla", Height = 3, Width = 3, Percent_price_per_lvl = 120, Percent_product_per_lvl = 130, Price = 5000, Destr_price = 1000, Product_per_h = 10},
              new Buildings {  Name = "Kopalnia złota", Height = 3, Width = 3, Percent_price_per_lvl = 130, Percent_product_per_lvl = 140, Price = 10000, Destr_price = 1000, Product_per_h = 10}
            );

            context.Produkty.AddOrUpdate(
              p => p.ID,
              new Products {  Name = "Drewno", Price_per_unit = 10, Unit = "m3"},
              new Products {  Name = "Węgiel", Price_per_unit = 30, Unit = "t"},
              new Products {  Name = "Złoto", Price_per_unit = 100, Unit = "kg" }
            );
